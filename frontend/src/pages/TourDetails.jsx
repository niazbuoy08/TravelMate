      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="col-span-1 bg-white p-6 shadow rounded-lg">
              ...
              {['00-06', '06-12', '12-18', '18-00'].map((option) => (
                <button
                  ...
                  className={`py-2 px-3 rounded-lg border ${
                    time === option ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700'
                  }`}
                >
                  {option}
                </button>
          ...
          <button
            ...
            className="w-full bg-yellow-500 text-white py-2 px-4 mt-4 rounded-md hover:bg-yellow-600 transition"
          >
            Apply Filters
          </button>
        </div>
